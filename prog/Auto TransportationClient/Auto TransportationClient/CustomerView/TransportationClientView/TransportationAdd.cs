...
using Auto_TransportationClient.CustomerView.TransportationClientView.RowView;
...
public partial class TransportationAdd : UserControl
{
    ...
    public TransportationAdd(TransportationControl mainController, Customer customer)
    {
        this.mainController = mainController;
        choisedCustomer = customer;
